...
#define ARM64_REG_TCR_A1_EL0 (0)
#define ARM64_REG_TCR_A1_EL1 (1 << 21)
...
#define ARM64_VA_KERNEL_BYTES (1UL << ARM64_VA_BITS)

#if ARM64_VA_BITS == 32
# define ARM64_VA_KERNEL_FIRST_ADDR 0xffffffff00000000
#elif ARM64_VA_BITS == 39
# define ARM64_VA_KERNEL_FIRST_ADDR 0xffffff8000000000
...
#define read_far_el1(out) asm("mrs %0, FAR_EL1" : "=r"(out))
#define read_sysreg_ttbr0(out) asm("mrs %0, TTBR0_EL1" : "=r"(out));

/*
#define ARM64_AP_OFFSET (6)
#define ARM64_AP_MASK (0b11 << ARM64_AP_OFFSET)
#define ARM64_AP_GET(n) ((n & ARM64_AP_MASK) >> ARM64_AP_OFFSET)
#define ARM64_AP_SET(n,v) \
	n &= ~(ARM64_AP_MASK); \
	n |= (v << ARM64_AP_OFFSET) & ARM64_AP_MASK
...
#define ARM64_MMU_ENTRY_AP_KERN_RW  (ARM64_MMU_ENTRY_AP_EL1_RW_EL0_NONE << 6)
#define ARM64_MMU_ENTRY_AP_KERN_RO  (ARM64_MMU_ENTRY_AP_EL1_RO_EL0_NONE << 6)
...
#define ARM64_MMU_ENTRY_NEXT_BLK (ARM64_MMU_ENTRY_VALID | ARM64_MMU_ENTRY_AF)
#define ARM64_MMU_ENTRY_NEXT_PAGE (ARM64_MMU_ENTRY_NEXT_TBL | ARM64_MMU_ENTRY_AF)

#define ARM64_MMU_ENTRY_WRITABLE(entry) \
	(entry & ARM64_MMU_ENTRY_NEXT_PAGE) && \
	((entry & ARM64_AP_MASK) == ARM64_MMU_ENTRY_AP_USER_RW)


#define ARM64_MMU_ENTRY_ATTR_NOCACHE  (0x2 << 2)
#define ARM64_MMU_ENTRY_ATTR_DMA    (0x1 << 2)
#define ARM64_MMU_ENTRY_ATTR_NORMAL (0x0 << 2)

// Valid kernel mappings
#define ARM64_MMU_ENTRY_KERNEL_RWX (ARM64_MMU_ENTRY_AP_KERN_RW)
#define ARM64_MMU_ENTRY_KERNEL_RO  (ARM64_MMU_ENTRY_AP_KERN_RO | ARM64_MMU_ENTRY_PXN | ARM64_MMU_ENTRY_UXN)
#define ARM64_MMU_ENTRY_KERNEL_RX  (ARM64_MMU_ENTRY_AP_KERN_RO | ARM64_MMU_ENTRY_UXN)
#define ARM64_MMU_ENTRY_KERNEL_RW  (ARM64_MMU_ENTRY_AP_KERN_RW | ARM64_MMU_ENTRY_UXN | ARM64_MMU_ENTRY_PXN)

// Valid for user+kernel
#define ARM64_MMU_ENTRY_UK_RWX (ARM64_MMU_ENTRY_AP_UK_RW)
#define ARM64_MMU_ENTRY_UK_RX  (ARM64_MMU_ENTRY_AP_UK_RO)
#define ARM64_MMU_ENTRY_UK_RO  (ARM64_MMU_ENTRY_AP_UK_RO | ARM64_MMU_ENTRY_UXN | ARM64_MMU_ENTRY_PXN)
#define ARM64_MMU_ENTRY_UK_RW  (ARM64_MMU_ENTRY_AP_UK_RW | ARM64_MMU_ENTRY_UXN | ARM64_MMU_ENTRY_PXN)

// Valid user mappings
#define ARM64_MMU_ENTRY_USER_RWX (ARM64_MMU_ENTRY_AP_USER_RW)
#define ARM64_MMU_ENTRY_USER_RO  (ARM64_MMU_ENTRY_AP_USER_RO | ARM64_MMU_ENTRY_PXN | ARM64_MMU_ENTRY_UXN)
#define ARM64_MMU_ENTRY_USER_RX  (ARM64_MMU_ENTRY_AP_USER_RO | ARM64_MMU_ENTRY_PXN)
#define ARM64_MMU_ENTRY_USER_RW  (ARM64_MMU_ENTRY_AP_USER_RW | ARM64_MMU_ENTRY_UXN | ARM64_MMU_ENTRY_PXN)
...
#define ARM64_MMU_SET_OA(entry, oa) \
	entry &= ~(ARM64_MMU_OA_MASK); \
	entry |= (oa & ARM64_MMU_OA_MASK)

#define ARM64_MMU_SET_TBL(entry, tbl) \
	entry &=  ~(ARM64_MMU_OA_MASK); \
	entry |= tbl
*/
...
#define ARM64_VA_LINEAR_START        (ARM64_VA_KERNEL_FIRST_ADDR + (4*GB))
...
#define ARM64_SHADOW_BYTES_PER (8)
#define ARM64_VA_SHADOW_START        (ARM64_VA_LINEAR_STOP)
#define ARM64_VA_SHADOW_SIZE         (ARM64_VA_KERNEL_BYTES / ARM64_SHADOW_BYTES_PER)
#define ARM64_VA_SHADOW_STOP         (ARM64_VA_SHADOW_START + ARM64_VA_SHADOW_SIZE)
#define ARM64_VA_KERNEL_VMMAP_START  (ARM64_VA_SHADOW_STOP)
#else
...
/*
#define ARM64_VA_KERNEL_SLAB_START   ARM64_VA_KERNEL_VMMAP_STOP
#define ARM64_VA_KERNEL_SLAB_SIZE    (1024 * MB)
#define ARM64_VA_KERNEL_SLAB_STOP    (ARM64_VA_KERNEL_SLAB_START + ARM64_VA_KERNEL_SLAB_SIZE)
*/
...
#define ARM64_VA_KERNEL_DMA_START (ARM64_VA_KERNEL_STACK_STOP)

#if (ARM64_VA_LINEAR_SIZE + ARM64_VA_KERNEL_VMMAP_SIZE + ARM64_VA_KERNEL_SLAB_SIZE + ARM64_VA_KERNEL_STACK_SIZE) > ARM64_VA_KERNEL_BYTES
# error "Allocated memory objects are larger than memory space"
#endif
...
#define ARM64_VA_USER_STOP  (1UL<<ARM64_VA_BITS)

#define ARM64_VA_THREAD_STACKS_SIZE  (PAGE_SIZE * (CONFIG_MAX_THREADS * CONFIG_THREAD_STACK_BLOCKS))
#define ARM64_VA_THREAD_STACKS_START (ARM64_VA_USER_STOP - ARM64_VA_THREAD_STACKS_SIZE)
#define ARM64_VA_THREAD_STACKS_STOP (ARM64_VA_THREAD_STACKS_START + ARM64_VA_THREAD_STACKS_SIZE)

// Place user slab at the end
#define ARM64_VA_USER_SLAB_SIZE   (128 * MB)
#define ARM64_VA_USER_SLAB_START  (ARM64_VA_USER_STOP - ARM64_VA_USER_SLAB_SIZE)
#define ARM64_VA_USER_SLAB_STOP   (ARM64_VA_USER_SLAB_START + ARM64_VA_USER_SLAB_SIZE)

/*
#define ARM64_MMU_CLONE_BIT_OFFSET (55)
#define ARM64_MMU_CLONE_MASK    (0b1UL << ARM64_MMU_CLONE_BIT_OFFSET)
#define ARM64_MMU_CLONE_AP_OFFSET  (56)
#define ARM64_MMU_CLONE_AP_MASK    (0b11UL << ARM64_MMU_CLONE_AP_OFFSET)
#define ARM64_MMU_CLONE_AP_VAL(n) ((n >> ARM64_MMU_CLONE_AP_OFFSET) & 0b11)
#define ARM64_MMU_CLONE_AP_CLEAR(n) (n &= ~(ARM64_MMU_CLONE_AP_MASK))
#define ARM64_MMU_CLONE_CLEAR(n) (n &= ~(ARM64_MMU_CLONE_MASK))

#define ARM64_MMU_CLONE_BIT (1UL << ARM64_MMU_CLONE_BIT_OFFSET)
#define ARM64_MMU_CLONED(entry) (entry & ARM64_MMU_CLONE_BIT)
#define ARM64_MMU_CLONE_OFF(entry) (entry &= ~(ARM64_MMU_CLONE_BIT))
//#define ARM64_MMU_CLONE_BITS (3)
//#define ARM64_MMU_CLONE_MAX  (1 << ARM64_MMU_CLONE_BITS)
//#define ARM64_MMU_CLONE_MASK (((1 << ARM64_MMU_CLONE_BITS)-1) << ARM64_MMU_CLONE_BIT_OFFSET)
//#define ARM64_MMU_CLONE_GET_VAL(entry) ((entry & ARM64_MMU_CLONE_MASK) >> ARM64_MMU_CLONE_BIT_OFFSET)
//#define ARM64_MMU_CLONE_SET_VAL(pgd,i,val) \
//	pgd[i] &= ~ARM64_MMU_CLONE_MASK; \
//	pgd[i] |= (val << ARM64_MMU_CLONE_BIT_OFFSET)


#define ARM64_MMU_ENTRY_VALID (1UL)
#define ARM64_MMU_ENTRY_INVALID (0UL)
#define ARM64_MMU_ENTRY_IS_VALID(entry) (entry & ARM64_MMU_ENTRY_VALID)
